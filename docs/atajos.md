...
| `↓` antes del primer clic | Círculo, polígono, rectángulo y arcos: plano **perpendicular a la arista** bajo el cursor (o paralelo a la cara), en magenta; `↓` otra vez lo libera |
