...
- **Actualizar vista** re-renderiza el marco desde el modelo actual; **Actualizar todas las vistas**, todos. Con **Renderizado automático** encendido, los marcos se actualizan solos cuando el modelo cambia — los marcos no son capturas, son ventanas vivas.
